                                                ...
                                                <div class="col-12">
                                                    <div class="pagination d-flex justify-content-center mt-5">
                                                        <a href="/products?page=${currentPage-1}${queryString}"
                                                            class="rounded ${currentPage eq 1? 'disabled':''}">&laquo;</a>
                                                        <c:forEach begin="1" end="${totalPages}" varStatus="loop">
                                                            <a href="/products?page=${loop.index}${queryString}"
                                                                class="rounded ${currentPage eq loop.index? 'active':''}">${loop.index}</a>
                                                        </c:forEach>
                                                        <a href="/products?page=${currentPage+1}${queryString}"
                                                            class="rounded ${currentPage eq totalPages? 'disabled':''}">&raquo;</a>
                                                    </div>
                                                </div>
                                            </c:if>
                                        </div>
